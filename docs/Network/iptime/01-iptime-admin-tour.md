...
이 세 묶음은 나중에 [포트 포워딩과 들어오는 연결](../basic/14-port-forwarding-and-incoming-connections.md){ data-preview }, [방화벽과 상태 기반 필터링](../basic/15-firewall-and-stateful-filtering.md){ data-preview }, [DHCP](../basic/16-dhcp.md){ data-preview }에서 본 개념과 하나씩 다시 이어질 거예요.
...
- 공유기가 집 안 주소를 실제로 어떻게 나눠주는지 바로 이어서 보고 싶다면 — [DHCP, 우리 집 기기들은 자기 주소를 어떻게 자동으로 받을까요?](../basic/16-dhcp.md){ data-preview }
