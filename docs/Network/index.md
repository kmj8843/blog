...
**실제로 어디서 보이고 어떻게 해석해야 하는지** 까지 이어져요.

---

## 그럼 다음엔 어디로 이어질까요?

지금 공개된 흐름은 이제 **DHCP** 까지 왔어요.
이제 그다음부터는, 같은 집 안의 기기를 실제로 어떻게 찾아가고 전달하는지까지 더 내려가볼게요.

- **17. ARP와 로컬 전달** — 주소는 받았는데, 같은 집 안의 진짜 목적지는 어떻게 찾을까요?
