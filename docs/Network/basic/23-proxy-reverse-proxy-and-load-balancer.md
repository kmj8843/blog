...
다음 글에서는 [**CDN, Cache, 그리고 Edge Delivery**](24-cdn-cache-and-edge-delivery.md){ data-preview } 이야기를 해볼게요. 이번 글이 서버 앞단의 **입구 정리**였다면, 다음 글은 전 세계 곳곳에 **복사본을 더 가까이 놓는 전략**으로 시야를 넓혀볼 차례예요.
