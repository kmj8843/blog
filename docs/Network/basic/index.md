...
description: 패킷부터 End-to-End Request Debugging까지, 처음부터 차근차근 따라가는 01~25 메인 시리즈 읽기 가이드예요.
...
**기본편 01~25 메인 시리즈**를 한눈에 따라갈 수 있게 정리해둔 읽기 가이드예요.
...
flowchart LR
    ...
    C[09~25<br/>실제 동작 파고들기<br/><small>handshake, NAT, 캡처, 프록시, CDN, 요청 디버깅</small>]
...
- [25. End-to-End Request Debugging](25-end-to-end-request-debugging.md){ data-preview } — 브라우저에서 시작한 요청 하나가 DNS, 연결, TLS, 프록시, 캐시, 오리진을 지나며 어디서 시간이 쓰이고 어디서 문제가 생기는지 어떻게 따라가 볼 수 있을까요?

---

## 25편까지 읽고 나면 어디로 가면 될까요?

기본편은 25편에서 한 번 큰 그림을 닫아요.
...
!!! abstract "기본편은 이렇게 읽으면 돼요"
    - 처음이라면 **01부터 25까지** 차례대로 읽는 게 가장 자연스러워요.
    - 이 기본편은 **직관 → 전체 지도 → 실제 요청 흐름** 순서로 깊어져요.
    - 25편은 기본편의 마침표이자, 이후 심화편으로 넘어가는 다리 역할을 해요.

그럼, 기본편은 어디부터 읽어볼까요?

<a class="md-button md-button--primary" href="01-what-is-packet/">01편부터 읽기</a>
<a class="md-button" href="25-end-to-end-request-debugging/">25편 보기</a>
