...
여기서부터는 메인 시리즈를 같은 방식으로 26편, 27편 늘려가기보다,
이 큰 흐름 위에서 **장면 하나를 더 깊게 파고드는 심화편** 으로 들어가는 쪽이 더 자연스러워요.
...
그러니까 이번 25편은 단순히 "다음 번호를 기다리는 글" 이라기보다,
**현재 기본편의 내용은 여기서 한 번 닫고, 이제부터는 심화편이 시작되는 문**이라고 생각하면 좋아요.

다음부터는 [심화편 입구](../deep-dive/index.md){ data-preview }에서,
패킷 캡처, 브라우저 타이밍, 캐시 헤더, 장애 장면처럼 **한 장면을 더 깊게 읽는 글들**로 이어가볼게요.
