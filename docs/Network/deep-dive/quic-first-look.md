...
오늘은 **QUIC이 한마디로 뭐인지**, **무엇과 연결되는지**, **왜 이런 방식이 생겼는지**, 그리고 그다음에야 **왜 UDP를 바닥으로 골랐는지**, **TLS는 어디에 들어가는지**, **HTTP/3 장면은 어떻게 달라지는지** 순서로 같이 볼게요. RFC 기준으로는 본문에서 [RFC 9000](https://www.rfc-editor.org/rfc/rfc9000), [RFC 9001](https://www.rfc-editor.org/rfc/rfc9001), [RFC 9114](https://www.rfc-editor.org/rfc/rfc9114), [RFC 9308](https://www.rfc-editor.org/rfc/rfc9308) 감각을 자연스럽게 이어서 참고할게요.
